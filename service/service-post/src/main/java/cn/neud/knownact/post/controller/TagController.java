...
import cn.neud.knownact.model.excel.post.TagExcel;
...
public class TagController {
    ...
    public Result<PageData<TagDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
    ...
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtils.exportExcelToTarget(response, null, list, TagExcel.class);
    }
